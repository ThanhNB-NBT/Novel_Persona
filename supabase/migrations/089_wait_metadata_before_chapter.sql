-- Không cho lane chương claim trước khi tên/mô tả truyện dịch xong.
-- Crawler xếp metadata trước rồi mới tạo chương mẫu, nhưng chốt DB vẫn cần cho job cũ
-- và yêu cầu dịch chương tạo thủ công trong lúc metadata còn chạy.
