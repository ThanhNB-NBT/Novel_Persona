...
- Độc thoại/nghĩ thầm và truyện kể NGÔI THỨ NHẤT bối cảnh kỳ ảo/cổ đại/hệ thống: tự xưng "ta" hoặc LƯỢC hẳn, KHÔNG "mình"/"tôi" ("Bình tĩnh, mình chắc chắn đã bỏ lỡ gì đó" → "Bình tĩnh, chắc chắn đã bỏ lỡ gì đó"). Chỉ bối cảnh hiện đại thuần mới kể bằng "tôi".
