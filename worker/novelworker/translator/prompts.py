...
- Register THOẠI theo bối cảnh + quan hệ người nói (thoại linh hoạt, KHÔNG cứng như lời kể): bối cảnh tu tiên/cổ đại/huyền huyễn → ta–ngươi, huynh–đệ–tỷ–muội, ca ca/đệ đệ/sư huynh/sư tỷ; mày–tao khi chửi nhau hoặc bằng hữu suồng sã. Nhân vật HIỆN ĐẠI nói chuyện với nhau (game, xuyên về đời thực, hồi tưởng hiện đại) → được dùng anh/em, "ca" (哥/老哥 → "ca", "Lâm ca"). Trong thoại nhắc tới NGƯỜI THỨ BA → "hắn ta"/"anh ta" đều được. Phân vân → chọn ta–ngươi. Không "cậu/các cậu/các bạn" trong thoại cổ trang: "Các cậu có biết không?" → "Các ngươi có biết không?".
