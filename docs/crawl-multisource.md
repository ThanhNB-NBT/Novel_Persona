...
>
> **Nguồn đang bật (4 dòng nguồn, 3 template):** `shuhaige` (biquge) · `ddxs` (dingdian) · `xsbique` (xinbiquge) · `faloo` (free-only). Thêm truyện Faloo: `add --book-id <id số> --source faloo` (ID từ URL `/new_{id}.html`).
>
